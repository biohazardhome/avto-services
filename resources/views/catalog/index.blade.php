...
@section('content')
	...
	<section class="catalog-list col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
		...
		<p>
			У вас поломался автомобиль и срочно нужен автосервис в Одинцово? Наш каталог автосервисов в Одинцово поможет найти ближайший подходящий сервис для вас и вашей машины. Так же вы можете получить полную информацию о интересующем вас автосервисе у нас, от адреса и телефона, до расположения на карте.
		</p>
