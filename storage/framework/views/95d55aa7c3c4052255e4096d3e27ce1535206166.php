<?php $__env->startSection('title', 'Автосервисы в Одинцово - адреса и телефоны автосервисов в Одинцово'); ?>
	...
	<section class="catalog-list col-md-8 col-lg-8 col-md-offset-2 col-lg-offset-2">
		...
		<?php foreach($catalog as $item): ?>
			<!-- <article class="catalog-item">
				<?php echo $__env->make('catalog.partials.item-header-link-city', $item->getAttributesOnly(['name', 'slug']) + ['city' => $item->city], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
				<?php echo $__env->make('catalog.partials.item-address-short-anchor', $item, array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
			...
			<?php echo $__env->make('catalog.item', compact('item'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
		<?php endforeach; ?>
